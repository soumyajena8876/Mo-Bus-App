...
public class Graph_M {
	...
	public static void Create_Metro_Map(Graph_M g) {
		g.addVertex("Patia");
		g.addVertex("Acharya Vihar Square");
		g.addVertex("Biju Pattnaik International Airport");
		g.addVertex("Nandankanan");
		g.addVertex("Baramunda Bus Stand");
		g.addVertex("Jaydev Vihar Square");
		g.addVertex("Master Canteen Square");
		g.addVertex("Khandagiri Square");
		g.addVertex("Fire Station Square");
		g.addVertex("CRPF Square");
		g.addVertex("Nayapalli");
		g.addVertex("Vani Vihar Square");
		g.addVertex("Kalpana Square");
		g.addVertex("Rasulgarh Square");
		g.addVertex("Damana Square");
		g.addVertex("Capital Hospital Square");
		g.addVertex("Uttara Chowk");
		g.addVertex("KIIT Square");
		g.addVertex("Infocity Square");
		g.addVertex("AG Square");

		g.addEdge("Patia", "Acharya Vihar Square", 8);
		g.addEdge("Acharya Vihar Square", "Biju Pattnaik International Airport", 10);
		g.addEdge("Biju Pattnaik International Airport", "Baramunda Bus Stand", 8);
		g.addEdge("Biju Pattnaik International Airport", "Nandankanan", 6);
		g.addEdge("Nandankanan", "Jaydev Vihar Square", 9);

		g.addEdge("Jaydev Vihar Square", "Master Canteen Square", 7);
		g.addEdge("Master Canteen Square", "Khandagiri Square", 6);
		g.addEdge("Fire Station Square", "CRPF Square", 15);
		g.addEdge("CRPF Square", "Rasulgarh Square", 6);
		g.addEdge("Rasulgarh Square", "Nandankanan", 7);

		g.addEdge("Nandankanan", "Kalpana Square", 1);
		g.addEdge("Kalpana Square", "Vani Vihar Square", 2);
		g.addEdge("Vani Vihar Square", "Nayapalli", 5);
		g.addEdge("Kalpana Square", "Damana Square", 2);
		g.addEdge("Damana Square", "Capital Hospital Square", 7);

		g.addEdge("Capital Hospital Square", "Uttara Chowk", 8);
		g.addEdge("Jaydev Vihar Square", "KIIT Square", 2);
		g.addEdge("AG Square", "KIIT Square", 2);
		g.addEdge("AG Square", "Infocity Square", 3);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("\n\t\t\t****WELCOME TO THE MO BUS APP*****");
		BufferedReader inp = new BufferedReader(new InputStreamReader(System.in));
		// STARTING SWITCH CASE
		while (true) {
			System.out.println("\t\t\t\t~~LIST OF ACTIONS~~\n\n");
			System.out.println("1. LIST ALL THE STOPS IN THE MAP");
			System.out.println("2. SHOW THE MO BUS MAP");
			System.out.println("3. GET SHORTEST DISTANCE FROM A 'SOURCE' STOP TO 'DESTINATION' STOP");
			System.out.println("4. GET SHORTEST TIME TO REACH FROM A 'SOURCE' STOP TO 'DESTINATION' STOP");
			System.out.println("5. GET SHORTEST PATH (DISTANCE WISE) TO REACH FROM A 'SOURCE' STOP TO 'DESTINATION' STOP");
			System.out.println("6. GET SHORTEST PATH (TIME WISE) TO REACH FROM A 'SOURCE' STOP TO 'DESTINATION' STOP");
